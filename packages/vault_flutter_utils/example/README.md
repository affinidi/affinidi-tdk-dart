...
For complete example and usage scenarios, please check the [example](https://github.com/affinidi/affinidi-tdk-dart/tree/main/packages/vault_flutter_utils/example/flutter_secure_storage) folder.
