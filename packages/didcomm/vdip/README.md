...
See [example/main.dart](https://github.com/affinidi/affinidi-tdk-dart/blob/main/packages/didcomm/vdip/example/main.dart) for a complete runnable example that demonstrates:
