...
dependencies:
  affinidi_tdk_credential_verification_client:
    git:
      ...
      ref: main
      path: clients/credential_verification_client
```
...
[*DefaultApi*](doc/DefaultApi.md) | [**verifyCredentialsV2**](doc/DefaultApi.md#verifycredentialsv2) | **POST** /v2/verifier/credentials | Verifying VC
...
[*DefaultApi*](doc/DefaultApi.md) | [**verifyPresentationV2**](doc/DefaultApi.md#verifypresentationv2) | **POST** /v2/verifier/presentation | Verifying VP
