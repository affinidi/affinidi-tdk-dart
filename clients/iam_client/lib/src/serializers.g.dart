...
Serializers _$serializers =
    (Serializers().toBuilder()
          ...
          ..add(
            PrincipalDoesNotBelongToProjectErrorHttpStatusCodeEnum.serializer,
          )
          ...
          ..add(
            PublicKeyCannotBeResolvedFromDidErrorHttpStatusCodeEnum.serializer,
          )
          ...
          ..add(
            TokenPrivateKeyAuthenticationMethodDtoPublicKeyInfoOneOf.serializer,
          )
          ..add(
          ...
          ..addBuilderFactory(
            const FullType(BuiltList, const [
              const FullType(PolicyStatementDto),
            ]),
          ...
          ..addBuilderFactory(
            const FullType(BuiltList, const [
              const FullType(ProjectWithPolicyDto),
            ]),
