...
```yaml
dependencies:
  affinidi_tdk_credential_issuance_client: ^1.11.0
```
...
dependencies:
  affinidi_tdk_credential_issuance_client:
    git:
      ...
      ref: main
      path: clients/credential_issuance_client
```
...
[*CredentialsApi*](doc/CredentialsApi.md) | [**batchCredential**](doc/CredentialsApi.md#batchcredential) | **POST** /v1/{projectId}/batch_credential | Allows wallets to claim multiple credentials at once.
