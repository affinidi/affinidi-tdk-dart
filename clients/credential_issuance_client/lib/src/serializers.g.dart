...
Serializers _$serializers =
    (Serializers().toBuilder()
          ...
          ..add(
            ProjectCredentialConfigNotExistErrorHttpStatusCodeEnum.serializer,
          )
          ...
          ..addBuilderFactory(
            const FullType(BuiltList, const [
              const FullType(ActionForbiddenErrorDetailsInner),
            ]),
          ...
          ..addBuilderFactory(
            const FullType(BuiltList, const [
              const FullType(CredentialSupportedObject),
            ]),
          ...
          ..addBuilderFactory(
            const FullType(BuiltList, const [
              const FullType(FlowDataStatusListsDetailsInner),
            ]),
            () => ListBuilder<FlowDataStatusListsDetailsInner>(),
          )
          ..addBuilderFactory(
            const FullType(BuiltList, const [
              const FullType(IssuanceConfigMiniDto),
            ]),
            () => ListBuilder<IssuanceConfigMiniDto>(),
          )
          ..addBuilderFactory(
            const FullType(BuiltList, const [
              const FullType(ListIssuanceResponseIssuancesInner),
            ]),
            () => ListBuilder<ListIssuanceResponseIssuancesInner>(),
          )
          ..addBuilderFactory(
            const FullType(BuiltList, const [
              const FullType(StartIssuanceInputDataInner),
            ]),
          ...
          ..addBuilderFactory(
            const FullType(BuiltList, const [
              const FullType(SupportedCredentialMetadataDisplayInner),
            ]),
