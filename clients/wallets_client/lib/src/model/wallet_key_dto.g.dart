...
const WalletKeyDtoAlgorithmEnum _$walletKeyDtoAlgorithmEnum_mldsa44 =
    const WalletKeyDtoAlgorithmEnum._('mldsa44');
...
WalletKeyDtoAlgorithmEnum _$walletKeyDtoAlgorithmEnumValueOf(String name) {
  switch (name) {
    ...
    case 'mldsa44':
      return _$walletKeyDtoAlgorithmEnum_mldsa44;
    default:
...
final BuiltSet<WalletKeyDtoAlgorithmEnum> _$walletKeyDtoAlgorithmEnumValues =
    BuiltSet<WalletKeyDtoAlgorithmEnum>(const <WalletKeyDtoAlgorithmEnum>[
      ...
      _$walletKeyDtoAlgorithmEnum_mldsa44,
    ]);
