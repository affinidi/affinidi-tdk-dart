...
Serializers _$serializers =
    (Serializers().toBuilder()
          ...
          ..add(
            LoginConfigurationReadInvalidClientIdErrorMessageEnum.serializer,
          )
          ...
          ..addBuilderFactory(
            const FullType(BuiltList, const [
              const FullType(GroupUserMappingDto),
            ]),
            () => ListBuilder<GroupUserMappingDto>(),
          )
          ..addBuilderFactory(
            const FullType(BuiltList, const [
              const FullType(InvalidParameterErrorDetailsInner),
            ]),
          ...
          ..addBuilderFactory(
            const FullType(BuiltList, const [
              const FullType(JsonWebKeyKeysInner),
            ]),
            () => ListBuilder<JsonWebKeyKeysInner>(),
          )
          ..addBuilderFactory(
            const FullType(BuiltList, const [
              const FullType(LoginConfigurationObject),
            ]),
            () => ListBuilder<LoginConfigurationObject>(),
          )
          ..addBuilderFactory(
            const FullType(BuiltList, const [
              const FullType(OAuth2TokenAuthorizationDetailsInner),
            ]),
          ...
          ..addBuilderFactory(
            const FullType(BuiltList, const [
              const FullType(IdTokenMappingItem),
            ]),
