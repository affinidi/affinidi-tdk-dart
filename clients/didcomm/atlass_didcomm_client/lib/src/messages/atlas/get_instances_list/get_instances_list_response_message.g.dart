...
MediatorInstanceBodyData _$MediatorInstanceBodyDataFromJson(
  ...
  instances: (json['instances'] as List<dynamic>)
      .map((e) => MediatorInstanceMetadata.fromJson(e as Map<String, dynamic>))
      .toList(),
...
Map<String, dynamic> _$MediatorInstanceBodyDataToJson(
  ...
  if (instance.lastEvaluatedKey case final value?) 'lastEvaluatedKey': value,
};
...
Map<String, dynamic> _$TrInstanceBodyDataToJson(
  TrInstanceBodyData instance,
) => <String, dynamic>{
  'instances': instance.instances.map((e) => e.toJson()).toList(),
  if (instance.lastEvaluatedKey case final value?) 'lastEvaluatedKey': value,
};
